...
function generateTree() {
  ...
  //const treeColors = ["#6D8821", "#8FAC34", "#98B333"];
  const treeColors = ["#fafcf5", "#3157d4", "#e63c30"];
  const color = treeColors[Math.floor(Math.random() * 3)];
...
function drawBalloon() {
 ...
 ctx.fillStyle = "#fafcf5";
 ctx.beginPath();
 ctx.arc(0, -40, 62, 0, Math.PI * 2, false);
 ctx.closePath();
  ctx.fill();
  ...
  // Balloon
  ctx.fillStyle = "#fafcf5";//#D62828
  ctx.beginPath();
  //ctx.moveTo(-30, -60);
  //ctx.quadraticCurveTo(-80, -120, -80, -160);
  ctx.arc(0, -160, 62, 0, Math.PI * 2, false);
  ...
  ctx.beginPath();
  ctx.arc(-20, -180, 5, 0, Math.PI * 2, false);
  ctx.closePath();
  ctx.fill();
  // eye right
  ctx.fillStyle = "#030302";
...
//left hand
  ...
  ctx.fillStyle = "#030302";
  ctx.beginPath();
  ctx.arc(0, -40, 5, 0, Math.PI * 2, false);
  ctx.arc(0, -20, 5, 0, Math.PI * 2, false);
  ctx.arc(0, -60, 5, 0, Math.PI * 2, false);
  ctx.closePath();
  ctx.fill();
...
function drawHeader() {
  ...
  ctx.fillText(`${score} seconds`, window.innerWidth - 700, 30);
}
...
function drawBackgroundTree(x, color) {
  ...
  const treeTrunkHeight = 11; //6
  //const treeTrunkWidth = 2;
  const treeTrunkWidth = 11;

  const treeCrownHeight = 9;
  const treeCrownWidth = 18;

//  const treeCrownHeight1 = 11;
//  const treeCrownWidth1 = 22;

  // Draw trunk
  ctx.fillStyle = "#dbaf7d";//"#030302"
  ctx.fillRect(
  -treeTrunkWidth / 2,
  -treeTrunkHeight,
  treeTrunkWidth,
  ...
  // draw crown red
  /*ctx.beginPath();
  ctx.moveTo(-treeCrownWidth1 / 2, -treeTrunkHeight);
  ctx.lineTo(0, -(treeTrunkHeight + treeCrownHeight1));
  ctx.lineTo(treeCrownWidth1 / 2, -treeTrunkHeight);
